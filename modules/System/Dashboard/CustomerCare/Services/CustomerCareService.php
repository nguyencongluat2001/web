...
namespace Modules\System\Dashboard\CustomerCare\Services;

use Modules\Base\Service;
use Modules\System\Dashboard\CustomerCare\Repositories\CustomerCareRepository;

class CustomerCareService extends Service
{
    ...
    {
        return CustomerCareRepository::class;
    }
    ...
    public function store($input){
        ...
        if($input['id'] != ''){
            ...
            $create = $this->repository->where('id',$input['id'])->update($arrData);
        }else{
