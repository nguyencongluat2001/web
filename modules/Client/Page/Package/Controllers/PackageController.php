...
namespace Modules\Client\Page\Package\Controllers;

use App\Http\Controllers\Controller;
use Modules\Base\Library;
use Illuminate\Http\Request;
use Modules\Client\Page\Package\Services\PackageService;
...
class PackageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('client.Package.home',$data)->render();
    }
     /**
    ...
    { 
        ...
        $data['param'] = $param;
        // dd($arrInput,$data);
        return view("client.Package.loadlist", $data)->render();
    }
    ...
    public function detailIndex(Request $request ,$code)
    {
        ...
        return view('client.Package.Detail.home',$datas);
    }
     /// chi tiết cơ sơ bệnh viện 
     /**
     *
    ...
    public function schedule(Request $request ,$code)
    {
        ...
        return view('client.Package.Schedule.home',$datas);
    }
     /// Danh sách huyện
     /**
     *
    ...
    public function createForm(Request $request)
    {
        ...
        // dd($input);
        $data['datas'] = $input;
        return view('client.Package.Schedule.edit',$data);
    }
