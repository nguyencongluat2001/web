function JS_Abount(baseUrl, module, controller) {
    this.module = module;
 ...
 * @return void
 */
JS_Abount.prototype.loadIndex = function () {
    var myClass = this;
    var oForm = 'form#frmAbount_index';
...
JS_Abount.prototype.loadevent = function (oForm) {
    var myClass = this;
    ...
    $(document).find("#linkVideo").on("change", function () {
        ...
        let getYoutubeId = JS_Abount.getYoutubeId(url)
    ...
    $(document).find("#fileInput").on('change', (e) => {
        ...
        files.forEach(file => {
            ...
            const exists = JS_Abount.selectedFiles.some(f =>
                f.name === file.name && f.size === file.size
            )

            if (!exists) {
                JS_Abount.selectedFiles.push(file)
            }
        })

        JS_Abount.renderPreview()
        this.value = ''
    })
}
/**
 ...
 * @return void
 */
JS_Abount.prototype.add = function (oForm) {
 ...
 * @return void
 */
JS_Abount.prototype.store = function (oFormCreate) {
 ...
 * @return void
 */
JS_Abount.prototype.loadList = function (oForm, numberPage = 1, perPage = 15) {
    var myClass = this;
 ...
 * @return void
 */
JS_Abount.prototype.edit = function (oForm) {
...
// Xoa bài viết
JS_Abount.prototype.delete = function (oForm) {
    var myClass = this;
    var listitem = '';
    var p_chk_obj = $('#table-data').find('input[name="chk_item_id"]');
    $(p_chk_obj).each(function () {
 ...
 * @return void
 */
JS_Abount.prototype.infoBlog = function (id) {
 ...
 * @return void
 */
JS_Abount.prototype.changePass = function (oForm) {
 ...
 * @return void
 */
JS_Abount.prototype.updatePass = function (oFormCreate) {
 ...
 * Check
 */
JS_Abount.prototype.checkValidate = function () {
...
JS_Abount.prototype.getYoutubeId = function(url) {
    let regExp =
...
JS_Abount.prototype.renderPreview = function () {
    var myClass = this
    const $list = $('#fileList')
    ...
    JS_Abount.selectedFiles.forEach((file, index) => {
...
JS_Abount.prototype.removeFile = function (index) {
    var myClass = this;
    JS_Abount.selectedFiles.splice(index, 1)
