function JS_FAQ(baseUrl, module, controller) {
    this.module = module;
 ...
 * @return void
 */
JS_FAQ.prototype.loadIndex = function() {
    var myClass = this;
 ...
 * Danh sách
 */
JS_FAQ.prototype.loadList = function(numberPage = 1, perPage = 15){
    var myClass = this;
 ...
 *
 */
JS_FAQ.prototype.edit = function (id) {
    var myClass = this;
    var url = this.urlPath + '/create';
 ...
 * Cập nhật
 */
JS_FAQ.prototype.update = function () {
    var oForm = '#frmAddFAQ';
 ...
 * Xoa doi tuong
 */
JS_FAQ.prototype.delete = function (oForm) {
    var myClass = this;
    var listitem = '';
