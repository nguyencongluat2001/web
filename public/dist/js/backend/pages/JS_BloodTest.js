function JS_BloodTest(baseUrl, module, controller) {
    this.module = module;
 ...
 * @return void
 */
JS_BloodTest.prototype.loadIndex = function () {
    var myClass = this;
    // $('.chzn-select').chosen({ height: '100%', width: '100%' });
    var oForm = 'form#frmBloodTest_index';
...
JS_BloodTest.prototype.loadevent = function (oForm) {
    var myClass = this;
    $('form#frmAdd').find('#btn_create').click(function () {
        myClass.store('form#frmAdd');
    })
 ...
 * @return void
 */
JS_BloodTest.prototype.add = function (oForm) {
 ...
 * @return void
 */
JS_BloodTest.prototype.store = function (oFormCreate) {
 ...
 * @return void
 */
JS_BloodTest.prototype.createMoneyPackage = function (oFormCreate) {
 ...
 * @return void
 */
JS_BloodTest.prototype.loadList = function (oForm, numberPage = 1, perPage = 15) {
    var myClass = this;
 ...
 * @return void
 */
JS_BloodTest.prototype.edit = function (oForm) {
 ...
 * @return void
 */
JS_BloodTest.prototype.editMoneyPackage = function (oForm) {
...
// Xoa mot doi tuong
JS_BloodTest.prototype.delete = function (oForm) {
    var myClass = this;
    var listitem = '';
    var p_chk_obj = $('#table-data').find('input[name="chk_item_id"]');
    $(p_chk_obj).each(function () {
 ...
 * @return void
 */
JS_BloodTest.prototype.seeVideo = function (id) {
