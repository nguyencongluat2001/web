function JS_Evaluate(baseUrl, module, controller) {
    this.module = module;
    this.baseUrl = baseUrl;
    this.controller = controller;
    NclLib.menuActive('.link-evaluate');
    NclLib.loadding();
    this.urlPath = baseUrl + '/' + module + '/' + controller;//Biên public lưu tên module
}
JS_Evaluate.prototype.alerMesage = function(nameMessage,icon,color){
    Swal.fire({
        position: 'top-start',
        icon: icon,
        title: nameMessage,
 ...
 * @return void
 */
JS_Evaluate.prototype.loadIndex = function () {
    var myClass = this;
...
JS_Evaluate.prototype.loadevent = function (oForm) {
    var myClass = this;
    $('form#frmAdd').find('#btn_create').click(function () {
        myClass.store('form#frmAdd');
    })
 ...
 * @return void
 */
JS_Evaluate.prototype.loadList = function (oForm) {
    var myClass = this;
...
//  * @return void
//  */
// JS_Evaluate.prototype.inFor = function (id) {
//     var myClass = this;
//     console.log(id)
//     var url = this.urlPath + '/loadList';
//     var data = $(oForm).serialize();
 ...
 * @return void
 */
JS_Evaluate.prototype.getHuyen = function (codeTinh) {
    var myClass = this;
    ...
    $.ajax({
        ...
        success: function (arrResult) {
            ...
            html += `<select onchange="JS_Evaluate.getXa(this.value)" class="form-control input-sm chzn-select" name="code_huyen" id="code_huyen">`
 ...
 * @return void
 */
JS_Evaluate.prototype.getXa = function (codeHuyen) {
    var myClass = this;
