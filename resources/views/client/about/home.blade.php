                ...
                <div class="row">
                    ...
                    <div class="product-item mb-4" data-code_category="{{ $blog->code_category ?? '' }}"  data-year="{{ $blog->detailBlog?->year ?? '' }}">
                        <a href="{{ route('project.reader', ['id' => $blog->id]) }}" class="image-link" style="position: relative;">
                            ...
                            <!-- <div class="inner-content"> -->
                                <div>
                                <h4 class="product-title" style="color: #ffffff !important;position: absolute;bottom: 0;font-size: 15px;background: #0707074d;right: 0;text-align: right;border-radius: 20px;padding: 10px;">{{ $blog->detailBlog?->title }}</h4>
