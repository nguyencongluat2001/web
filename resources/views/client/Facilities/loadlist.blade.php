...
@foreach ($datas as $key => $data)
  <a href="{{url('/facilities')}}/{{$data->code}}" class="col-sm-6 col-lg-4 text-decoration-none project marketing social business" style="padding:10px">
    <div class="service-work overflow-hidden card  m-sm-0">
        <img class="card-img-top" style="height: 150px;object-fit: cover;" src="{{url('/file-image-client/avatar-abount/')}}/{{ !empty($data->avatar)?$data->avatar:'' }}" alt="...">
        <div class="card-body" >
    ...
    <!-- <div class="col-md-3 mb-3">
        <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
            <img class="recent-work-img card-img" style="height: 150px;width: 300px;object-fit: cover;" src="{{url('/file-image-client/avatar-abount/')}}/{{ !empty($data->avatar)?$data->avatar:'' }}" alt="Card image">
