...
@section('body')
    <script type="text/javascript" src="{{ URL::asset('dist\js\backend\pages\JS_Abount.js') }}"></script>
    ...
    <script type="text/javascript">
        var baseUrl = '{{ url('') }}';
        var JS_Abount = new JS_Abount(baseUrl, 'system', 'abount');
        $(document).ready(function($) {
            JS_Abount.loadIndex(baseUrl);
        })
