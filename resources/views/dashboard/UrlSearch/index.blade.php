...
@section('body')
    <script type="text/javascript" src="{{ URL::asset('dist\js\backend\pages\JS_UrlSearch.js') }}"></script>
    {{-- <link  href="../assets/css/argon-dashboard.css?v=2.0.4" rel="stylesheet" /> --}}
    <div class="container-fluid">
        <div class="row">
            <form action="" method="POST" id="frmUrlSearch_index">
    ...
    <script type="text/javascript">
        var baseUrl = '{{ url('') }}';
        var JS_UrlSearch = new JS_UrlSearch(baseUrl, 'system', 'urlsearch');
        $(document).ready(function($) {
            JS_UrlSearch.loadIndex(baseUrl);
        })
    </script>
@endsection
